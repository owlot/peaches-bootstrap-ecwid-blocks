...
if ( empty( $product_id ) && is_admin() ) {
	...
	<div class="alert alert-info">
		<?php echo esc_html__( 'This is a dynamic product detail template. The actual product will be displayed based on the URL when viewed on the frontend.', 'ecwid-shopping-cart' ); ?>
	</div>
	<?php
}
...
if ( ! empty( $product_id ) ) {
	...
	if ( empty( $product_data ) ) {
		...
		<div class="alert alert-warning">
			<?php echo esc_html__( 'Product could not be found', 'ecwid-shopping-cart' ); ?>
		</div>
		<?php
	} else {
		echo $content;
	...
	?>
	<div class="alert alert-warning">
		<?php echo esc_html__( 'No product found. Please check the URL and try again.', 'ecwid-shopping-cart' ); ?>
	</div>
	<?php
}
