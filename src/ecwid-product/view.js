        ...
        *initProduct() {
            ...
            try {
                ...
                if (data && data.success && data.data) {
                    ...
                    throw new Error('Failed to fetch product data: ' + (data?.data || 'Unknown error'));
                }
            } catch (error) {
                ...
                try {
                    if (typeof window.Ecwid !== 'undefined' && window.Ecwid.Product && window.Ecwid.Product.get_by_id) {
                        const product = window.Ecwid.Product.get_by_id(productId);
                    ...
                    console.error('Error fetching from Ecwid client API:', ecwidError);
                }
